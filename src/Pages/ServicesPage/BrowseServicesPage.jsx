        ...
        <Box>
            <Container maxWidth="xl">
                <BoxStyledTitle>
                    <Grid container spacing={{ xs: 3, md: 2 }} columns={{ xs: 1, sm: 3, md: 12 }} justifyContent="center" alignItems="center">
                        <Grid item xs={12} sm={2} md={8} >
                            <HeaderComponent title="Services" breadcrumbs={breadcrumbs} />
                        </Grid>
                        <Grid item xs={12} sm={1} md={4} style={{ textAlign: 'right' }}>
                            <Button variant="contained" themecolor="rentalBtnSmall" startIcon={<AddIcon />} onClick={handleAddService}>
                                Add Service
                            </Button>
                        </Grid>
                    </Grid>
                ...
                <Paper elevation={0} variant="mainMarginNoPadding">
                    ...
                    <DataGridComponent
                        data={services}
                        handleClear={handleClearServices}
                        type="services"
                        headCells={headCells}
