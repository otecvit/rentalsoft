...
const CustomerComponent = ({ chTokenCustomer = "", actions }) => {
    ...
    return (
        ...
        <Container maxWidth="xl">
            <BoxStyledTitle>
                {onSkeleton ?
                    <HeaderComponent title={actions === "edit" ? getValues("chFirstName") : "Create a new customer"} breadcrumbs={breadcrumbs} />
                    : <Skeleton width="50%" />
                }
            </BoxStyledTitle>
                                    ...
                                    <Accordion key={item.id} expanded={expanded === `panel${index}`} onChange={handleChangeAccordion(`panel${index}`)}>
                                        ...
                                        <AccordionDetails>
                                            ...
                                            <BoxStyled sx={index === 0 && { marginTop: '13px' }}>
                                                <Grid container spacing={{ xs: 3, md: 2 }} columns={{ xs: 1, sm: 3, md: 2 }}>
